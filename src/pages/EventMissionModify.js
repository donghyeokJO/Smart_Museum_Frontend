...
import style from './css/admin/EventMissionModify.module.css';

function EventMissionModify() {
    ...
    useEffect(() => {
        ROOT_API.event_get_by_id('JWT ' + access, id)
            .then((res) => {
                ...
                setAddList(res.data['inner_exhibition']);
            })
    }, []);
            ...
            .then((res) => {
                ...
                ROOT_API.event_mission_modify('JWT ' + access, id, formdata, inner_exhibition)
                    .then((res) => {
                        ...
                        window.location.href = '/event-mission-detail?id=' + id;
                    })
                    .catch((err) => {
                        console.log(err);
                ...
                <div className={`${style.content} ${style.mEvent_write} ${style.WRITEFORM}`}>
                    <div className={style.pageHead}>
                        ...
                        <div className={style.Headgroup}>
                            ...
                            <Button variant="primary" onClick={() => modifyEvent()}>저장</Button>
                        </div>
                    </div>
...
export default withRouter(EventMissionModify);